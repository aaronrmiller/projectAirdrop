...
const WorkingMemoryCMPT = props => {
  const WM_content = [
    <SectionInstructions
      instructions={props.WM.instructions[0].instruction_text}
    />,
    ...
    <SectionInstructions
      instructions={props.WM.instructions[1].instruction_text}
    />,
  ...
  if (props.currentSlide === 0) {
    currentBTN = (
      <UserStartBTN
        action={props.startPractice}
        buttonText={"Start Practice"}
      />
    );
  } else if (props.currentSlide === 6) {
    currentBTN = (
      <UserStartBTN action={props.startTest} buttonText={"Start Test"} />
    );
  }
